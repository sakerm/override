...
il nous demande une entree et et nous retourne "child is exiting".
GDB!
...
le programme appel un fork est un gets(). il y a ensuite un check avec ptrace et regarde si le gets() recupere la fonction "exec"?
...
nous pouvons faire overflow le gets()
...
le programme est en pleine boucle inifini j'usqu'au segfault, donc nous allons exploiter ca
...
[Switching to process 1986]
0x6e6e6e6e in ?? ()
(gdb) i r
eax            0x0	0
ecx            0xf7fd08c4	-134412092
edx            0xffffd660	-10656
